...
export default function ParamsBar() {
    ...
    return(
        <div>
            <div><label> Size Mesh {meshDivisions}</label> <input onChange={(e) => {setMeshDivisions(e.target.value) }} type={"range"} min="2" max="40" step="2" defaultValue={config.meshDivisions} /></div> 
